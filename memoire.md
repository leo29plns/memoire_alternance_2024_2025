...
Rendre compte d'une progression, d'une évolution personnelle et profesionnelle, en se référant à MMI.
...
Ça y est, j'y suis ! Après trois mois de travail consécutif au sein de Groupe Progress, je peux enfin le dire : j'ai réalisé ma première expérience professionnelle.

Comme n'importe quelle expérience professionnelle, on arrive avec des attentes.  
La première d'entre elle est simple, c'est la rémunération pour le travail effectué. C'est la contrepartie pour avoir donné de son temps et de sa force de travail. Le stage n'étant pas le statut professionnel le plus valorisant financièrement parlant, il va de soi que ce n'était pas ma première attente.  
La deuxième attente, moins formelle, est pourtant celle qui avait le plus de sens à mes yeux : l'enrichissement personnel. Celui-ci se matérialise de plein de formes différentes. Peut-être souhaite-t-on développer nos compétences techniques, nos compétences organisationnelles, notre capacité à travailler en groupe ? Mais ces attentes s'accompagnent aussi de celles qui sont implicites. Le travail est aujourd’hui l’un des principaux marqueurs de reconnaissance sociale : c’est souvent la première chose que l'on mentionne lorsqu’on se présente. Mes amis, ma famille : que vont-ils en penser ?
...
Je présentais alors au 22 juin de la même année ce travail de réflexion, cet exercice introspectif, devant madame Florence BISTER et monsieur Renaud EPSTEIN. Au cours de cette soutenance, j'ai pu exprimer le déroulé de mon stage, et surtout, la dissonance entre mes attentes préalables et la réalité du terrain. J'y exprime notamment une reconnaissance somme toute relative au sein de l'entreprise, mais surtout un sentiment de détachement vis-à-vis des autres employés.  
Le statut de stagiaire est peut-être déjà une première clef pour comprendre ce sentiment, mais il y avait aussi ce regard qu'on portait sur les développeurs. Ce regard comme si le développeur n'était finalement qu'une brique parmi tant d'autres pour réaliser une production numérique. C'est presque un jugement déshumanisant porté sur l'équipe.  
...
Après avoir conclu ma soutenance, et répondu à l'ensemble des question du jury, vient enfin le temps pour moi de me préparer à partir pour laisser la place au prochain candidat. Ce moment est souvent accompagné d'un relâchement, l'exercice étant terminé, la pression et le stress diminuent donc. C'est un moment propice aux discussions officieuses.  
C'est donc en rangeant mes affaires que monsieur EPSTEIN m'interpelle et me confie : le constat que j'ai posé lui semble intéressant, et remet en perspective le métier de développeur. La phrase suivante a particulièrement retenu mon attention :  
> « Finalement, le développeur est en train de devenir presque un ouvrier, à force de tâches répétitives […]  »

Le temps a passé, et quelques mois plus tard, me voilà dans une autre entreprise. Je découvre alors un univers significativement différent, que ce soit en termes d'échelle, de périmètre de projet, ou même encore de projet en lui-même.  
Une chose a marqué mon arrivée dans cette entreprise : je vais travailler au sein d'une grande équipe appelée _Digital Factory_, littéralement, « l'usine numérique ».

Ce terme de _Digital Factory_ m'est familier. Il me rappelle un concept vague que j'avais croisé à plusieurs reprises sur internet : la désignation comme telle d'une équipe de développeurs illustre une vision du travailleur comme d'un maillon d'une chaîne de production. Caricaturée, l’usine, c’est là où l’individu devient interchangeable et où chaque geste est compté, chronométré et calibré pour ne servir que le rendement.

Le terme de _Digital Factory_ se trouve être finalement galvaudé. Le docteur Fabian NAMBERGER en fait l'illustration dans @DigitalFactoryReview [].  
Fabian NAMBERGER est chercheur postdoctoral en design urbain à l’Université HafenCity de Hambourg. Son parcours universitaire offre une vision concrète et matérielle de certains concepts parfois abstraits. Notamment, ses derniers travaux portent sur l’intégration des plateformes numériques dans l’espace urbain. Cela permet de mettre en relief une économie numérique qui se projette en dehors des écrans. C'est à l'image de sa thèse de doctorat portant sur les activités de l'entreprise de VTC Uber dans la ville de Toronto.

@DigitalFactoryReview [] montre un concept cynique de l'usine numérique, mettant en parallèle les « player-workers » du jeu vidéo _World of Warcraft_ en Chine. « While customers from the United States, Europe, Japan and Korea pay a little extra for fast progress through the game, Chinese player-workers spend hours on end on the same repetitive click tasks ». Les travailleurs effectuent des tâches répétitives et routinières dans un environnement analog, révélant que le numérique repose sur un travail proche de celui d’une usine traditionnelle.  
Alors, de cela se dégage une question légitime : si le terme de Digital Factory connote négativement le travail, pourquoi avoir nommé ainsi une équipe de développeurs ?

Tout cela m’a ramené à mon échange avec Renaud EPSTEIN et à cette phrase qui m’avait marqué : le développeur est-il en train de devenir un ouvrier ? La question n’est pas simple, mêlant nature des tâches, considération des pairs et répétition des gestes. Travailler dans une _Digital Factory_ équivaut-il à être un ouvrier ? Travailler à la Digital Factory : col blanc ou col bleu ?

Cette interrogation sur le statut du développeur dans une _Digital Factory_ mobilise une métaphore sociologique bien connue : celle de l’opposition entre « col blanc » et « col bleu ». Traditionnellement, le premier renvoie aux emplois intellectuels ou administratifs, qualifiés de professionnels ou de cadres, où la créativité, l’autonomie et la réflexion occupent une place prépondérante. À l’inverse, le second désigne les emplois manuels ou industriels, associés à la répétition des gestes, à la standardisation des tâches et à une subordination hiérarchique marquée. Or, dans le contexte d’une _Digital Factory_, cette distinction devient incertaine : le travail des développeurs est à la fois intellectuel et technique, mais il est aussi fortement structuré, répétitif et encadré, ce qui rappelle certains aspects du travail ouvrier. Dès lors, une question se pose : la _Digital Factory_ constitue-t-elle un espace de production créative et flexible, caractéristique des cols blancs, ou bien reproduit-elle les logiques d’industrialisation et de routine propres aux cols bleus ?
